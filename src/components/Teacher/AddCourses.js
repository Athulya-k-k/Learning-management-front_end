  ...
  {cats.map((category) => (
    <option key={category.id} value={category.id}>{category.title}</option>
                ...
                <div className="mb-3">
                  ...
                  <input onChange={handleChange} type="text" name="description" className="form-control" id="description" />
                </div>
                ...
                <div className="mb-3">
                  ...
                  <input onChange={handleChange} type="text" name="techs" className="form-control" id="techs" />
                </div>
